...
{{< scss-docs name="root-body-variables" file="node_modules/bootstrap/scss/_root.scss" >}}

In practice, those variables are then applied in Reboot like so:

{{< scss-docs name="reboot-body-rules" file="node_modules/bootstrap/scss/_reboot.scss" >}}
