...
{{< scss-docs name="root-form-validation-variables" file="node_modules/bootstrap/scss/_root.scss" >}}

These variables are also color mode adaptive, meaning they change color while in dark mode.

### Sass variables

{{< scss-docs name="form-feedback-variables" file="node_modules/bootstrap/scss/_variables.scss" >}}

{{< scss-docs name="form-validation-colors" file="node_modules/bootstrap/scss/_variables.scss" >}}

{{< scss-docs name="form-validation-colors-dark" file="node_modules/bootstrap/scss/_variables-dark.scss" >}}

### Sass mixins

Two mixins are combined, through our [loop](#sass-loops), to generate our form validation feedback styles.

{{< scss-docs name="form-validation-mixins" file="node_modules/bootstrap/scss/mixins/_forms.scss" >}}

### Sass maps

This is the validation Sass map from `_variables.scss`. Override or extend this to generate different or additional states.

{{< scss-docs name="form-validation-states" file="node_modules/bootstrap/scss/_variables.scss" >}}
...
{{< scss-docs name="form-validation-states-loop" file="node_modules/bootstrap/scss/forms/_validation.scss" >}}
