...
{{< scss-docs name="form-input-variables" file="node_modules/bootstrap/scss/_variables.scss" >}}

`$form-label-*` and `$form-text-*` are for our `<label>`s and `.form-text` component.

{{< scss-docs name="form-label-variables" file="node_modules/bootstrap/scss/_variables.scss" >}}

{{< scss-docs name="form-text-variables" file="node_modules/bootstrap/scss/_variables.scss" >}}

`$form-file-*` are for file input.

{{< scss-docs name="form-file-variables" file="node_modules/bootstrap/scss/_variables.scss" >}}
