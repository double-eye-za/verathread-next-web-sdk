...
{{< scss-docs name="modal-css-vars" file="node_modules/bootstrap/scss/_modal.scss" >}}

{{< scss-docs name="modal-backdrop-css-vars" file="node_modules/bootstrap/scss/_modal.scss" >}}

### Sass variables

{{< scss-docs name="modal-variables" file="node_modules/bootstrap/scss/_variables.scss" >}}

### Sass loops

[Responsive fullscreen modals](#fullscreen-modal) are generated via the `$breakpoints` map and a loop in `scss/_modal.scss`.

{{< scss-docs name="modal-fullscreen-loop" file="node_modules/bootstrap/scss/_modal.scss" >}}
