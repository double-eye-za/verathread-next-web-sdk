...
{{< scss-docs name="dropdown-css-vars" file="node_modules/bootstrap/scss/_dropdown.scss" >}}
...
{{< scss-docs name="dropdown-dark-css-vars" file="node_modules/bootstrap/scss/_dropdown.scss" >}}

### Sass variables

Variables for all dropdowns:

{{< scss-docs name="dropdown-variables" file="node_modules/bootstrap/scss/_variables.scss" >}}

Variables for the [dark dropdown](#dark-dropdowns):

{{< scss-docs name="dropdown-dark-variables" file="node_modules/bootstrap/scss/_variables.scss" >}}

Variables for the CSS-based carets that indicate a dropdown's interactivity:

{{< scss-docs name="caret-variables" file="node_modules/bootstrap/scss/_variables.scss" >}}

### Sass mixins

Mixins are used to generate the CSS-based carets and can be found in `scss/mixins/_caret.scss`.

{{< scss-docs name="caret-mixins" file="node_modules/bootstrap/scss/mixins/_caret.scss" >}}
